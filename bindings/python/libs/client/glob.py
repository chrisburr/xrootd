...
def split_url(url):
    """Split URL into domain and path components."""
...
def xrootd_iglob(pathname, url_params, raise_error):
    ...
    for dirname in dirs:
        ...
        # IMPORTANT: Use path + "/" + url_params to properly handle URL parameters
...
def glob(pathname, raise_error=False):
    ...
    Returns:
      (list): A list of paths that match the wild-carded string
    """
